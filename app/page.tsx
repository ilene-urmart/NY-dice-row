...
export default function NewYearDiceGame() {
  ...
  const chanceCards: CardType[] = [
    ...
    {
      title:
        "擲骰子一次，擲出奇數可以獲得任一蛋白點心，擲出偶數則將自己任一款蛋白點心送給右邊玩家",
    },
    {
      title:
        "跟你左邊的玩家組成一組！由任一玩家進行平板撐，另外的玩家在他背上立水瓶；成功的話兩人可各選擇一款想要的蛋白點心",
    },
    {
      title:
        "邀請所有玩家模仿在健身房裡最討厭聽到的一句話（例如「你還有幾組？」），所有玩家投票最像的人可前進兩格",
    },
    { title: "平板支撐 30 秒，成功就獲得一根蛋白酥脆條" },
    { title: "說出三個蛋白質含量高的年菜，成功就能拿一塊蛋白堅果巧克磚" },
    { title: "隨機指定一位玩家做 30 下開合跳，若他完成，兩人各得一包即吞肌酸" },
    {
      title:
        "你是今天的教練！請選擇任一玩家做任一動作並維持 30 秒，該玩家若成功即可獲得一根蛋白酥脆條與一塊蛋白堅果巧克磚（自由分配）",
    },
    {
      title:
        "和左邊的玩家比賽：誰能最快做完 10 下波比跳，贏的玩家可獲得一包透明乳清",
    },
    {
      title:
        "跟右邊的玩家比賽 ：誰能在 10 秒內說出最多種的運動，輸的玩家需要把自己任一款蛋白點心放回禮盒中",
    },
    {
      title:
        "請指定任一名玩家與他猜拳，輸的玩家需要把自己任一款蛋白點心放回禮盒中",
    },
    { title: "跟右邊的玩家比賽拇指摔角，贏的玩家可以拿一塊蛋白堅果巧克磚" },
    {
      title:
        "拿出手機，秀出你最近一次健身紀錄！若 7 天內有健身紀錄即可獲得一根蛋白酥脆條",
    },
    { title: "可選擇與你右邊的玩家交換一個蛋白點心" },
    { title: "可選擇與淺藍色啞鈴玩家交換一個蛋白點心" },
    { title: "可選擇讓你左邊的玩家將任一蛋白點心贈予你" },
    { title: "可指定任一玩家與你交換一款蛋白點心" },
    {
      title:
        "把跟親友遊玩的照片分享到 IG 限時動態並 @urmart_tw，完成可自由選擇任一蛋白點心",
    },
    {
      title:
        "邀請任一玩家跟你比賽伏地挺身，一分鐘內做比較多下的玩家即可以獲得一塊蛋白堅果巧克磚",
    },
    {
      title:
        "邀請任一玩家跟你比賽平板撐，最先放棄的人就輸了！輸的玩家需要倒退 3 格",
    },
    { title: "可選擇是否掠奪深藍色啞鈴玩家任一蛋白點心" },
  ];
  ...
  const destinyCards: CardType[] = [
    ...
    {
      title: "沒抵擋住過年桌上的零食誘惑，把自己的蛋白堅果巧克磚吃掉",
    },
    {
      title:
    ...
    {
      title:
        "想喝蛋白粉的你發現家裡已經沒有存貨了！把一包透明乳清放回禮盒中（若手中無透明乳清，則無視此張牌）",
    },
    {
      title:
        "剛剛去健身喝了蛋白粉補充體力；把一包透明乳清放回禮盒中並前進 2 格（若手中無透明乳清，則無視此張牌）",
    },
    {
    ...
    {
      title:
        "在運動的時候遇見黃色啞鈴玩家，分享給他你最近吃到覺得很好吃的 UrP!CK 蛋白堅果巧克磚；把你有的蛋白巧克磚送給他（若手中無蛋白巧克磚，則無視此張牌）",
    },
    {
      title:
        "去健身房前補充了肌酸，將即吞肌酸放回禮盒中（若手中無即吞肌酸，則無視此張牌）",
    },
    {
      title:
        "今天早上出去運動的你現在有點餓了；如果你有蛋白酥脆條，請吃掉一根補充體力（若手中無蛋白酥脆條，則無視此張牌）",
    },
    {
      title: "如果你現在沒有蛋白堅果巧克磚，補給一塊！",
    },
    {
