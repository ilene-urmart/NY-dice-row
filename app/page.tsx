...
export default function NewYearDiceGame() {
  ...
  const chanceCards: CardType[] = [
    ...
    { title: "隨機指定一人做 30 下開合跳，若他完成，你們兩人各得一包即吞肌酸" },
    {
      title:
        "你是今天的教練！請指定一玩家做 30 秒指定動作，成功可獲得一根蛋白酥脆條與一塊蛋白堅果巧克磚（自由分配）",
    },
  ...
  const destinyCards: CardType[] = [
    ...
    {
      title:
        "剛剛去健身喝了蛋白粉補充體力；把一包透明乳清放回禮盒中並前進 2 格",
    },
    {
    ...
    {
      title:
        "在運動的時候遇見黃色啞鈴玩家，分享給他你最近吃到覺得很好吃的 UrP!CK 蛋白堅果巧克磚；把你有的蛋白巧克磚送給他",
    },
    {
      title: "去健身房前補充了肌酸，將即吞肌酸放回禮盒中",
    },
    {
      title:
